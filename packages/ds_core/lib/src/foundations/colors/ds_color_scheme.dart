...
class DsColorScheme extends ThemeExtension<DsColorScheme> {
  ...
  DsColorScheme lerp(covariant ThemeExtension<DsColorScheme> other, double t) {
    ...
    return DsColorScheme(
      ...
      backgroundEnabled:
          Color.lerp(backgroundEnabled, other.backgroundEnabled, t)!,
      backgroundWarning:
      ...
      borderDefaultSecondary:
          Color.lerp(borderDefaultSecondary, other.borderDefaultSecondary, t)!,
      ...
      buttonSecondaryBorderDisabled: Color.lerp(buttonSecondaryBorderDisabled,
          other.buttonSecondaryBorderDisabled, t)!,
      buttonTertiaryText:
      ...
      buttonDestructiveHover:
          Color.lerp(buttonDestructiveHover, other.buttonDestructiveHover, t)!,
      buttonDestructiveDisabled: Color.lerp(
          buttonDestructiveDisabled, other.buttonDestructiveDisabled, t)!,
      buttonDestructiveText:
          Color.lerp(buttonDestructiveText, other.buttonDestructiveText, t)!,
      textFieldBackground:
      ...
      textFieldBorderFocused:
          Color.lerp(textFieldBorderFocused, other.textFieldBorderFocused, t)!,
      textFieldBorderHover:
          Color.lerp(textFieldBorderHover, other.textFieldBorderHover, t)!,
      textFieldBorderDisabled: Color.lerp(
          textFieldBorderDisabled, other.textFieldBorderDisabled, t)!,
      textFieldBorderError:
          Color.lerp(textFieldBorderError, other.textFieldBorderError, t)!,
      textFieldBorderSuccess:
          Color.lerp(textFieldBorderSuccess, other.textFieldBorderSuccess, t)!,
      textFieldBackgroundDisabled: Color.lerp(
          textFieldBackgroundDisabled, other.textFieldBackgroundDisabled, t)!,
      textFieldTextDisabled:
          Color.lerp(textFieldTextDisabled, other.textFieldTextDisabled, t)!,
      ...
      textFieldCursorError:
          Color.lerp(textFieldCursorError, other.textFieldCursorError, t)!,
      textFieldLabel: Color.lerp(textFieldLabel, other.textFieldLabel, t)!,
      textFieldLabelFocused:
          Color.lerp(textFieldLabelFocused, other.textFieldLabelFocused, t)!,
      textFieldHelper: Color.lerp(textFieldHelper, other.textFieldHelper, t)!,
      textFieldErrorText:
          Color.lerp(textFieldErrorText, other.textFieldErrorText, t)!,
      textFieldSuccessText:
          Color.lerp(textFieldSuccessText, other.textFieldSuccessText, t)!,
      ...
      navigationBarShadow:
          Color.lerp(navigationBarShadow, other.navigationBarShadow, t)!,
      ...
      loadingIndicatorColorPrimary: Color.lerp(
          loadingIndicatorColorPrimary, other.loadingIndicatorColorPrimary, t)!,
    );
  }
}
